...
export default function Edit({ attributes, setAttributes }) {
	...
	const blockProps = useBlockProps({ className: "calla-pricing-hero" });
	...
	return (
		<>
			...
			<section {...blockProps}>
				<div className="calla-pricing-hero__bg" style={backgroundStyle} aria-hidden="true" />
				<div className="calla-pricing-hero__inner">
					<p className="calla-pricing-hero__breadcrumb">
						<a href={breadcrumbHomeUrl || "#"}>
							{breadcrumbHomeLabel || __("Home", "ai-zippy-child")}
						</a>
						<span className="calla-pricing-hero__separator" aria-hidden="true">
							/
						</span>
						<span>{breadcrumbCurrentLabel || __("Our Pricing", "ai-zippy-child")}</span>
					</p>
					<RichText
						tagName="h1"
						...
						placeholder={__("Pricing page title", "ai-zippy-child")}
					/>
				</div>
			</section>
		</>
