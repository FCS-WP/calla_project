...
export default function Edit({ attributes, setAttributes }) {
	...
	const blockProps = useBlockProps({ className: "calla-recharge-hero" });
	...
	return (
		<>
			...
			<section {...blockProps}>
				<div className="calla-recharge-hero__bg" style={backgroundStyle} aria-hidden="true" />
				<div className="calla-recharge-hero__inner">
					<p className="calla-recharge-hero__breadcrumb">
						<a href={breadcrumbHomeUrl || "#"}>
							{breadcrumbHomeLabel || __("Home", "ai-zippy-child")}
						</a>
						<span className="calla-recharge-hero__separator" aria-hidden="true">
							/
						</span>
						<span>{breadcrumbCurrentLabel || __("Recharge", "ai-zippy-child")}</span>
					</p>
					<RichText
						tagName="h1"
						...
						placeholder={__("Recharge page title", "ai-zippy-child")}
					/>
				</div>
			</section>
		</>
